...
interface IResolutionRelayable {
    ...
    function dispute(address market, uint256 marketId) external;
}
...
contract ResolutionForwarder is ERC2771Forwarder {
    ...
    constructor(address collateral_, address initializer_)
        ERC2771Forwarder("Numera Resolution Forwarder")
    {
